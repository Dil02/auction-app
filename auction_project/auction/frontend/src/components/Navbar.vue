...
<template>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
        <div class="container-fluid">
            <span class="navbar-brand mb-0 h1"><router-link to="/">Name</router-link></span>
            ...
            <div class="collapse navbar-collapse" id="NavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <div class="nav-link"><router-link to="/test">Auction</router-link></div>
                    </li>
                    <li class="nav-item">
                        <div class="nav-link"><router-link to="/item">Add Item</router-link></div>
                    </li>
                    <li class="nav-item ml-auto">
                        <div class="nav-link"><router-link to="/item">Login</router-link></div>
                    </li>
                </ul>
            </div>
        </div>
